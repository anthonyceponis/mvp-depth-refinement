...
accelerate launch --num_processes $num_gpus ppd_sharpdepth/training/train.py \
    ...
    --student_ckpt_dir_revision trained/sharpdepth_loss/checkpoint-2500 \
    --add_datetime_prefix \
    --report_to wandb \
    ...
    --output_dir "$WORKSPACE_DIR/train_output_sharpdepth_loss_1/" \
    --base_model zoedepth \
    ...
    --max_sds_timestep 249 \
    --use_sharpdepth_style_losses \
    --wandb_name "controlnet_sharpdepth_loss" \
    "$@"